<%-- 
    Document   : adminaddsales
    Created on : Mar 31, 2017, 8:38:00 PM
    Author     : bala
--%>
            ...
            <div class="app" id="app">
                ...
                <article class="content item-editor-page">
                    <div class="title-block">
                        <h3 class="title"> Add new Salesman <span class="sparkline bar" data-type="bar"></span> </h3>
                    </div>
                    <form name="item" action="AdminSalesmanServlet" method="post">
                        <div class="card card-block">
                            <div class="form-group row"> <label class="col-sm-2 form-control-label text-xs-right">
                                    Name:
                                </label>
                                <div class="col-sm-10"> <input type="text" class="form-control boxed" placeholder="Name" name="username" required> </div>
                            </div>
                            <div class="form-group row"> <label class="col-sm-2 form-control-label text-xs-right">
                                    Mobile No:
                                </label>
                                <div class="col-sm-10"> <input type="text" class="form-control boxed" placeholder="Mobile No." name="mobileno" required> </div>
                            </div>
                            <div class="form-group row"> <label class="col-sm-2 form-control-label text-xs-right">
                                    E-mail:
                                </label>
                                <div class="col-sm-10"> <input type="email" class="form-control boxed" placeholder="E-mail" name="email" required> </div>
                            </div>
                            <div class="form-group row"> 
                                <label class="col-sm-2 form-control-label text-xs-right">
                                    Address:
                                </label>
                                <div class="col-sm-2"> <input type="text" class="form-control boxed" placeholder="Door No" name="doorno"> </div>
                                <div class="col-sm-4"> <input type="text" class="form-control boxed" placeholder="Street Name" name="streetname" required> </div>
                                <div class="col-sm-4"> <input type="text" class="form-control boxed" placeholder="City" name="city" required> </div>
                            </div>
                            <div class="form-group row"> 
                                <div class="col-sm-2"></div>
                                <div class="col-sm-4"> <input type="text" class="form-control boxed" placeholder="District" name="district" required> </div>
                                <div class="col-sm-3"> <input type="text" class="form-control boxed" placeholder="State" name="state" required> </div>
                                <div class="col-sm-3"> <input type="text" class="form-control boxed" placeholder="Pincode" name="pincode" required> </div>
                            </div>
                    </form>
