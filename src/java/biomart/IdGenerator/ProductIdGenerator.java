        ...
        try {
           ...
           Connection con = DBUtil.getDBConnection();
            ...
            try {
                ...
                resultSet = statement.executeQuery("Select Product_Seq.nexttval from dual");
            } catch (Exception e) {
                statement.execute("create sequence Product_Seq start with 1 increment by 1 nocycles nocache");
                resultSet = statement.executeQuery("Select Product_Seq.nexttval from dual");
            }
            if (resultSet.next()) {
